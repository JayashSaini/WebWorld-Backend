...
const sendEmail = async (options) => {
  ...
  const mail = {
    from: 'webworld@gmail.com', // We can name this anything. The mail will go to your Mailtrap inbox
...
const emailVerificationMailgenContent = (username, verificationUrl) => {
  return {
    body: {
      name: username,
      intro: 'Welcome to Web World! Please Verify Your Email',
      action: {
        instructions:
...
async function subscriptionSendmail(options) {
  try {
    ...
    <body>
    <div class="container">
    <h2>Congratulations for Subscribing to Web World!</h2>
    <p>Dear User,</p>
    <p>Thank you for subscribing to Web World! Here is your coupon code:
